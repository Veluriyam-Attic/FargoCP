...
[JITWhenModsEnabled("GodMode"), ExtendsFromMod("GodMode")]
public class GodModeLocal : ModSystem
{
    //public static Mod godmode = null;
    //public static Type gtype = null;
    public override void Load()
    {

        if (ModLoader.GetMod("GodMode") != null)
        {
            //godmode= ModLoader.GetMod("GodMode");
             //godmode.GetType();
            ForceLocalizeSystem.LocalizeByTypeFullName("GodMode.World", " PostDrawFullscreenMap", new Dictionary<string, string>()
            {
    ...
    [JITWhenModsEnabled("GodMode"), ExtendsFromMod("GodMode")]
    internal class ForceLocalizeSystem : ForceLocalizeSystem<Mod, ForceLocalizeSystem>
    {
    ...
    public abstract class ForceLocalizeSystem<Mod, TSelf> where TSelf : ForceLocalizeSystem<Mod, TSelf> /* where T : Mod */
    {
        #region Instance
        ...
        /// <br/>包含命名空间, 由 '.' 分隔
        /// <br/>例: FargoCP.Systems.ForceLocalizeSystem
        /// <br/>如果是内嵌类型, 则用 '+' 连接
        /// <br/>例: FargoCP.Systems.ForceLocalizeSystem+TypeHelper
        /// </param>
        ...
        public static class TypeHelper
        {
            ...
            private static void Initialize()
            {
                ...
                initialized = true;
                Type mod = ModLoader.GetMod("GodMode").GetType();
                FargoCP.gmod = mod;
                modAssembly = mod.Assembly; //typeof(mod.GetType()).Assembly; // mod.Code??
                typesByName = [];
                typeByFullName = [];
                duplicatedNames = [];
